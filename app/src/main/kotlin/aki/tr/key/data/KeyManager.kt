...
class KeyManager(context: Context) {
    ...
    companion object {
        private const val KEY_ALIAS = "smartrans_secure_key"
    ...
    private fun encrypt(plainText: String): String {
        val secretKey = getSecretKey() ?: throw IllegalStateException("Keystore unavailable")
    ...
    private fun saveKeys(providerId: String, keys: List<String>): Boolean {
        ...
        return try {
            prefs.edit().putString(KEY_PREFIX + providerId, encrypt(arr.toString())).apply()
